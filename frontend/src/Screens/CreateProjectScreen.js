...
function CreateProjectScreen() {
  ...
  return (
    ...
    if(values.openedFor.includes('donate') && !values.donationAmount){
      errors.donationAmount =  "Donation amount is required" 
    }else if(values.openedFor.includes('volunteer') && !values.volunteerNumber){
      errors.volunteerNumber =  "Volunteer no required to open project for volunteering." 
    }
             ...
             <>
              <Form onSubmit={handleSubmit}>
                ...
                <Form.Group className="mt-2">
                  ...
                  <Form.Select
                  className={errors.location && "border-danger focus-danger error_focus "}
                    ...
                    onChange={handleChange}
                  >
                  <option className={errors.location && 'text-danger'}>Choose your country</option>
                ...
                <Form.Group className="mt-2">
                  ...
                  />
                  <p className="text-danger">
                    {errors.donationAmount && touched.donationAmount && errors.donationAmount}
                  </p>
                </Form.Group>
                      )
}
{ values.openedFor.includes('volunteer') && (
                <Form.Group className="mt-2">
                  ...
                  />
                  <p className="text-danger">
                    {errors.volunteerNumber && touched.volunteerNumber && errors.volunteerNumber}
                  </p>
                </Form.Group>
                      )
}
